...
public class MakeMusic implements AbcListener {
    ...
    /**
     * Returns the Music constructed by this object.
     * Requires that this object has completely walked over a Music parse tree 
     * using ParseTreeWalker.
     * @return Music for the Music parse tree that was walked
     */
